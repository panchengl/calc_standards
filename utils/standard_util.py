...
if __name__ == "__main__":
    ...
    # transform_data(result_dir=cfg.single_img_result_dir, transform_result_dir=cfg.transform_result_dir,
    #                classes=cfg.names_class)
    # print(cfg.class_dict)
    # calculate_performance_index_3label(cfg.root_data_dir, transform_result_dir=cfg.transform_result_dir,
    #                                    dict_class=cfg.class_dict)